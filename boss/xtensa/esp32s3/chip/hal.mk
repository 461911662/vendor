...
# endif
ARCHSCRIPT += $(TOPDIR)$(DELIM)$(ESP_HAL_CUST_CHIP_CFG_PATH)$(DELIM)ld$(DELIM)$(CHIP_SERIES).rom.newlib.ld
...
CHIP_CSRCS += chip$(DELIM)$(ESP_HAL_3RDPARTY_REPO)$(DELIM)components$(DELIM)hal$(DELIM)lcd_hal.c
...
CHIP_CSRCS += chip$(DELIM)$(ESP_HAL_3RDPARTY_REPO)$(DELIM)components$(DELIM)soc$(DELIM)$(CHIP_SERIES)$(DELIM)lcd_periph.c
